...
from usuarios_manager import cargar_usuarios, guardar_usuarios
...
class AdminFrame(ctk.CTkFrame):
    ...
    def refrescar_sucursales(self):
        productos = cargar_productos()
        sucursales = obtener_sucursales(productos)
    ...
    def agregar_producto(self):
        ...
        def guardar():
            ...
            stock_por_sucursal = {}
            agregar_producto(categoria, nombre, precio, image_path or "", stock_por_sucursal)
    ...
    def agregar_producto_dialog(self):
        ...
        agregar_producto(categoria, nombre, precio_f, imagen or "", stock_por_sucursal)
        messagebox.showinfo("OK", "Producto agregado.")
        self.refrescar_productos()
        self.refrescar_sucursales()
    ...
    def editar_stock_dialog(self):
        ...
        if nuevo is None:
            return
        ok = actualizar_stock(categoria, nombre, sucursal, nuevo)
        if ok:
    ...
    def eliminar_producto_dialog(self):
        ...
        if not confirm:
            return
        ok = eliminar_producto(categoria, nombre)
        if ok:
